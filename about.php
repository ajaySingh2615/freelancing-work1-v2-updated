        ...
        <div class="story-content">
            <div class="story-text">
                <div class="story-text-content">
                    ...
                    <p>Our founders, Mr. Mohd Irshad and Dr. Azaz Ahamad, both having experienced the challenges of pursuing medical education abroad, were determined to create a bridge between ambitious students and world-class medical institutions.</p>
                </div>
        ...
        <div class="team-grid team-grid-two-cards">
            ...
            <div class="team-member">
                ...
                <div class="member-content">
                    <h4 class="member-name">Mr. Mohd Irshad</h4>
                    <span class="member-position">Managing Director</span>
                    <p class="member-bio">
